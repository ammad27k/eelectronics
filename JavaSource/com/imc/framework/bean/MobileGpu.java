...
/**
 * MobileGpu generated by hbm2java
 */
public class MobileGpu implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1763772414648792111L;
	private Long id;
	...
	public MobileGpu(String title, Character isActive, Character isDeleted,
			Set<?> mobilePhoneses) {
		this.title = title;
